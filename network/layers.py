...
from .utils_vm import is_affine, extract_affine_ndims, affine_shift_to_identity, affine_identity_to_shift
from .utils_vm import transform, integrate_vec, affine_to_shift
from . import utils_vm
...
class ComposeTransform(Layer):
    ...
    def _single_dense_compose(self, inputs):
        return utils_vm.compose(inputs[0], inputs[1])
